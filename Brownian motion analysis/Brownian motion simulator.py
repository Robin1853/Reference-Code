...
ab_ratio = 1.0                     #Sets the alpha/beta ratio of the denoising loss function: alpha * d + beta * c
...
est_drift, U, V, W =lda.local_estimator(signal, dt = dt, space_borders=plot_range, grid_step=grid_step, radii_ratio=radii_ratio)
lda.score(true_drifts, est_drift)
#print(U[drift_test_point], V[drift_test_point], W[drift_test_point])
